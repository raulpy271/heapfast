...
func main() {
	...
	js.Global().Set("NewHeap", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		heapref["add"] = js.FuncOf(func(this js.Value, args []js.Value) any {
			v := this.Get("pos").Int()
			h := &heaps[v]
			h.AddItem(heapfast.Record[uint32]{uint32(args[0].Int()), uint32(args[1].Int())})
			return nil
		})
		heapref["addBulk"] = js.FuncOf(func(this js.Value, args []js.Value) any {
			...
			l := keys.Length()
			for i := range l {
				h.AddItem(heapfast.Record[uint32]{uint32(keys.Index(i).Int()), uint32(values.Index(i).Int())})
			}
			return nil
		})
	...
	js.Global().Set("Heapsort", js.FuncOf(func(this js.Value, args []js.Value) any {
		...
		records := internal.CastRecordsFromBytes[uint32](dst)
